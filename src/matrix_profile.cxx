...
int main(int argc, char** argv) {
    ...
    log("Calculating matrix_profile segment");
    ...
    if (rank == LEADER) {
        ...
        //log("Sending matrix_profile to LEADER");
    ...
    if (rank == LEADER) {
        //log("Writing out matrix_profile");
