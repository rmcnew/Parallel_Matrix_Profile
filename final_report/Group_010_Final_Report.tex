...
\author{\IEEEauthorblockN{Richard McNew\IEEEauthorrefmark{1} and Brody Larsen\IEEEauthorrefmark{2}}
\IEEEauthorblockA{Department of Computer Science, Utah State University\\ Logan, Utah, USA\\
\IEEEauthorrefmark{1}a02077329@usu.edu, \IEEEauthorrefmark{2}a01977457@usu.edu}
}
...
Describe the test data sets and why they were chosen.

\section{Results}
The MPI Matrix Profile implementation calculated the same results as the STUMPY Matrix Profile implementation with X\% accuracy.

Create a table for these results:
AAPL\_matrix\_profile.csv average matrix profile percent difference: 0.000000003
AMZN\_matrix\_profile.csv average matrix profile percent difference: 0.001487219
AirPassengers\_matrix\_profile.csv average matrix profile percent difference: 0.000000000
MSFT\_matrix\_profile.csv average matrix profile percent difference: 0.000000005
TSLA\_matrix\_profile.csv average matrix profile percent difference: 0.398995692
california\_covid19\_cases\_matrix\_profile.csv average matrix profile percent difference: 0.007563099
daily\_min\_temperature\_matrix\_profile.csv average matrix profile percent difference: 0.004481254
us\_gdp\_matrix\_profile.csv average matrix profile percent difference: 0.000000015

Could not find jena\_climate\_2009\_2016\_matrix\_profile.csv
Put an overall percent difference too
